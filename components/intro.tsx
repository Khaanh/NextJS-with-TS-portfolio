		...
		>
				...
				<div className="relative">
					...
					>
						<Image
							...
							width="192"
							height="192"
							className="h-24 w-24 rounded-full border-[0.35rem] border-white object-cover border-white shadow-xl"
						/>
					</motion.div>
					<motion.span
			...
			>
				...
				<a
					href=""
					target="_blank"
					className="bg-white p-4 text-gray-700 flex items-center gap-2 rounded-full focus:scale-[1.15] hover:scale-[1.15] active:scale-105 transition cursor-pointer border borderBlack"
				>
					<BsLinkedin />
				</a>
